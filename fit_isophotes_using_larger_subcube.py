...
def run(cube_name,centre,length,length_axis, mask_cube = False, mask_centres = [], mask_extents = [],
    ...
    Inputs:
        ...
        length:[int,int] is the coordinate of the distance to cut to, either vertically or horizontally from the centre_coord depending if length_axis is 'x' or 'y'
        ...
        run(cube_name='MAGPI1203',centre=[196,196], length=[196,261],length_axis='x',mask_cube=True,mask_centres=[[153,197],[194,213],[238,191],[194,163],[153,195],[227,219],[205,245],[170,233],[
    ...
    # create subcube
    create_subcube(cube_name, centre, length,subtype = 'cube',length_axis=length_axis, larger_subcube = False, pixels_larger = pixels_larger, mask_cube = mask_cube, mask_centres = mask_centres,mask_extents = mask_extents)
    
    # create larger subcube
    create_subcube(cube_name, centre, length,subtype = 'cube',length_axis=length_axis, larger_subcube = True, pixels_larger = pixels_larger, mask_cube = mask_cube, mask_centres = mask_centres,mask_extents = mask_extents)
